...
document.addEventListener('DOMContentLoaded', function() {
    const animatedElements = document.querySelectorAll('.category, .service, .stat');
...
function showLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            <div style="width: 50px; height: 50px; border: 3px solid #e2e8f0; border-top: 3px solid #2563eb; border-radius: 50%; animation: spin 1s linear infinite; margin: 0 auto 20px;"></div>
            <h3 style="color: #2563eb; font-family: Inter, sans-serif;">Loading...</h3>
        </div>
    `;
...
// showLoadingScreen(); // Uncomment if you want a loading screen
...
const printStyles = `
    @media print {
        .header, .footer, .back-to-top, .hamburger { display: none !important; }
        .hero { page-break-after: always; }
        body { font-size: 12pt; }
        .section-header h2 { font-size: 18pt; }
    }
`;
